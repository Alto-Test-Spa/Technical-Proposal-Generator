// Isotipo de Alto Test (la catenaria) — igual al de site/src/components/ui/Logomark.tsx.
// A diferencia de informe_levantamiento, acá NO se usa la variante con anclajes en los
// extremos: esa es específica de ese documento (trata justamente de anclajes), no la
// marca general de Alto Test.
