// Wordmark de Alto Test (texto + catenaria) — igual a site/src/components/ui/Wordmark.tsx.
// Ver Logomark.tsx: acá no se usa la variante con anclajes de informe_levantamiento.
